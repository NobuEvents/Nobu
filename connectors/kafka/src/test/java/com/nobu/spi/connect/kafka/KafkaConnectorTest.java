...
public class KafkaConnectorTest {
  ...
  private void initialize(String bootstrapServers) {
    ...
    Context context = new Context("kafka", "kafka", connectionConfig, routeConfig);

    kafkaConnector.initialize("target", context);
  }
  ...
  void testPublishEvent()
    ...
    KafkaConnector connector = Mockito.mock(KafkaConnector.class);
